...
class JointController:
    ...
    def __init__(self):
        ...
        self.joint_subscriber = rospy.Subscriber("/matlab_joint_config", JointState, self.jointMsgCallback)
        self.gripper_subscriber = rospy.Subscriber("/matlab_gripper_action", Bool, self.gripperMsgCallback)
